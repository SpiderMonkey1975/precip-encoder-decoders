...
from networks.unet import unet_1_layer, unet_2_layer, unet_3_layer
...
print("         * using ERA5-%s atmopsheric pressure level input")
...
inputfile = "input_data/training/z_era5_" + args.data + "_CLASSIFICATION.npy"
...
modelSave = ModelCheckpoint( filepath='checkpoints/classifier_model.{epoch:02d}-{val_acc:4f}.hdf5',
                             monitor='val_acc',
                             save_best_only=True,
                             mode='max' )
...
inputfile = "input_data/test/z_era5_" + args.data + "_CLASSIFICATION.npy"
...
print("       prediction accuracy was %4.3f"  % (score[1]))
